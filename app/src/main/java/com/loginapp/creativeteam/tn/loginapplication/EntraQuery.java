...
public class EntraQuery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entra_query);
                ...
                if (TextUtils.isEmpty(cname.getText())) {
                    ...
                    user.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                Toast.makeText(EntraQuery.this, "Welcome!", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(EntraQuery.this,ProfileActivity.class);
                                startActivity(intent);
                                finish();
                            } else {
                                ParseUser.logOut();
                                Toast.makeText(EntraQuery.this, e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
