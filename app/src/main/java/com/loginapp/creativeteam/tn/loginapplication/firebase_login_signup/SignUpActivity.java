...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /* mInputEmail = myIntent.getStringExtra("email"); // will return "FirstKeyValue"
       mInputPassword= myIntent.getStringExtra("pass");
       mInputName=myIntent.getStringExtra("name");
        // Views

*/
      mInputName="Ifkwne Onfkwf";
      mInputEmail="lekfjb@gmail.com";
      mInputPassword="dl6546kfqbjbbjfw";
